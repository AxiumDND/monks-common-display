...
# Version 13.0.3
* Updated to use ApplicationV2 for better V13 compatibility
* Fixed namespace references for InteractionLayer and ContextMenu
* Fixed renderSceneControls hook to handle HTMLElement instead of jQuery
